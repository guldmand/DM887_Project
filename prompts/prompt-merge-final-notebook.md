...
Inspect these candidate notebooks:
...
2. the clearest statement of the official assignment and midway scope,
3. the most robust ObjectRL config discovery,
4. the safest subprocess runner,
5. the best log/status handling,
6. the most adaptable evaluation-return parser,
7. one clean plotting implementation,
8. markdown cells useful for the midway report.

The final notebook must support:
- PPO, SAC, TD3
- continuous Car Racing, cartpole-swingup-v0, acrobot-swingup-v0
- seeds 0, 1, 2, 3, 4
- debug/midway/final modes
- logs/results under results/
- figures under figures/midway/
